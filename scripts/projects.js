function disp_p4p1(lang) {
    ...
    document.getElementById('box_footer_left_icon').innerHTML = '<img onclick="disp_kb(\''+lang+'\');" src="https://p4p1.github.io/img/flopx2.png"/>';
...
function disp_kb(lang) {
    ...
    document.getElementById('box_footer_right_icon').innerHTML = '<img onclick="disp_p4p1(\''+lang+'\');" src="https://p4p1.github.io/img/peachx2.png" />';
