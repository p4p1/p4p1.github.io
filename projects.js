...
function disp_p4p1() {
    ...
    document.getElementById('box_logo').innerHTML = '<img src="https://p4p1.github.io/img/pixpeachx2.png" />';
...
function disp_larp() {
    ...
    document.getElementById('box_footer_left_icon').innerHTML = '<img onclick="disp_p4p1();" src="https://p4p1.github.io/img/pixpeachx2.png"/>';
...
function disp_kb() {
    ...
    document.getElementById('box_footer_right_icon').innerHTML = '<img onclick="disp_p4p1();" src="https://p4p1.github.io/img/pixpeachx2.png" />';
